  ...
  return (
    ...
    >
      ...
      <Box display='flex' gap={5}>
              ...
              <DownloadMenu extentions={existingExtentions} handelClick={handleDownloadClick} buttonText={'Download Collection'} isVector={false} />
              <DownloadMenu extentions={vectorExtentions} handelClick={handelSettingVectorExtention} buttonText={'Download as vectore'} isVector={true}/>
            <Link to='/DownloadVector' style={{display: 'none'}} ref={linkRef}>
            </Link>
      </Box>
